...
public class PregnancyDate {
    ...
    private final long daysToBirth;
    private final long daysUntilNow;
    private final long weeksUntilNow;
    private final long restOfWeekUntilNow;
    private final long xteWeek;
    private final long xteMonth;
